...
describe('Product e2e test', () => {
  ...
  const productSample = { title: 'foreground Avon', price: 13280 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="title"]`).type('South payment').should('have.value', 'South payment');

      cy.get(`[data-cy="price"]`).type('84837').should('have.value', '84837');
